...
//                rxDialogSure.getLogoView().setImageResource(R.drawable.logo);
    ...
    public static Dialog createLoadingDialog(Context context) {
        ...
        final int viewWidth = DensityUtils.dip2px(context, 150);
...
//        builder.setPositiveButton("确定", listener);
    ...
    public static void showActionSheet(Context context, String[] others, OnItemClickListener onItemClickListener) {
