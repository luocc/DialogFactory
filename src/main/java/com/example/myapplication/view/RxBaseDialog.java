...
public class RxBaseDialog extends Dialog {
    ...
    public RxBaseDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public RxBaseDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
     ...
     */
    public RxBaseDialog(Context context, float alpha, int gravity) {
        super(context);
